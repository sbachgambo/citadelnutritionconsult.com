<?php
/**
 * Title: About Michelle — full page
 * Slug: cnc-theme/about-michelle-full
...
<section class="wp-block-group alignwide" style="padding-top:var(--wp--custom--spacing--section-gap);padding-bottom:var(--wp--custom--spacing--section-gap)">
	...
	<div class="wp-block-columns are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<p class="has-accent-color has-text-color has-small-font-size">CREDENTIALS &amp; BACKGROUND</p>
			<!-- /wp:paragraph -->
			<!-- wp:paragraph -->
			<p>Michelle Umeadi, RDN, leads Citadel Nutrition Consult as a leading nutritional service provider based in Nigeria, specializing in managing chronic conditions including diabetes, hypertension, and obesity. Her approach emphasizes sustainable transformation — not quick fixes.</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		<!-- wp:column {"verticalAlignment":"center"} -->
...
<!-- wp:pattern {"slug":"cnc-theme/about-michelle-team"} /-->
...
<section class="wp-block-group alignwide has-surface-background-color has-background" style="padding-top:var(--wp--custom--spacing--section-gap);padding-bottom:var(--wp--custom--spacing--section-gap)">
	...
	<!-- wp:heading {"textAlign":"center"} --><h2 class="has-text-align-center">Diet Talk with Dietitian Michelle</h2><!-- /wp:heading -->
	<!-- wp:paragraph {"align":"center"} -->
	<p class="has-text-align-center">Michelle's radio show bringing practical nutrition advice to a wider audience, also available as video episodes. <a href="https://youtube.com/@diettalkwithdm" target="_blank" rel="noopener">Visit the full channel →</a></p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-columns" style="margin-top:2rem">
		<!-- wp:column -->
		<div class="wp-block-column">
			<!-- wp:embed {"url":"https://youtu.be/4dXYlera83g","type":"video","providerNameSlug":"youtube","responsive":true,"className":"wp-embed-aspect-16-9 wp-has-aspect-ratio"} -->
			<figure class="wp-block-embed is-type-video is-provider-youtube wp-block-embed-youtube wp-embed-aspect-16-9 wp-has-aspect-ratio"><div class="wp-block-embed__wrapper">
			https://youtu.be/4dXYlera83g
			</div></figure>
			<!-- /wp:embed -->
		</div>
		<!-- /wp:column -->
		<!-- wp:column -->
		<div class="wp-block-column">
			<!-- wp:embed {"url":"https://youtu.be/oTLcfjOAg_Y","type":"video","providerNameSlug":"youtube","responsive":true,"className":"wp-embed-aspect-16-9 wp-has-aspect-ratio"} -->
			<figure class="wp-block-embed is-type-video is-provider-youtube wp-block-embed-youtube wp-embed-aspect-16-9 wp-has-aspect-ratio"><div class="wp-block-embed__wrapper">
			https://youtu.be/oTLcfjOAg_Y
			</div></figure>
			<!-- /wp:embed -->
		</div>
		<!-- /wp:column -->
		<!-- wp:column -->
		<div class="wp-block-column">
			<!-- wp:embed {"url":"https://youtu.be/SeOw_xN7h_E","type":"video","providerNameSlug":"youtube","responsive":true,"className":"wp-embed-aspect-16-9 wp-has-aspect-ratio"} -->
			<figure class="wp-block-embed is-type-video is-provider-youtube wp-block-embed-youtube wp-embed-aspect-16-9 wp-has-aspect-ratio"><div class="wp-block-embed__wrapper">
			https://youtu.be/SeOw_xN7h_E
			</div></figure>
			<!-- /wp:embed -->
		</div>
		<!-- /wp:column -->
...
<!-- wp:pattern {"slug":"cnc-theme/testimonials"} /-->

<!-- wp:group {"tagName":"section","align":"wide","layout":{"type":"constrained","contentSize":"720px"}} -->
<section class="wp-block-group alignwide">
	<!-- wp:heading {"textAlign":"center"} --><h2 class="has-text-align-center">Real results</h2><!-- /wp:heading -->
	<!-- wp:image {"sizeSlug":"large","style":{"border":{"radius":"10px"}}} -->
	<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/patterns/about-michelle-results.jpg' ) ); ?>" alt="A client's before-and-after transformation, guided by Citadel Nutrition Consult" style="border-radius:10px"/></figure>
	<!-- /wp:image -->
</section>
<!-- /wp:group -->
